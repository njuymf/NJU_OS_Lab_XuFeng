...
void initIdt() {
	...
	// switch (i) {
	// case 0x00:
	// 	setTrap(idt + i, SEG_KCODE, (uint32_t)irqErrorCode, DPL_KERN);
	// 	break;
	// case 0x08:
	// 	setTrap(idt + i, SEG_KCODE, (uint32_t)irqDoubleFault, DPL_KERN);
	// 	break;
	// case 0x0a:
	// 	setTrap(idt + i, SEG_KCODE, (uint32_t)irqInvalidTSS, DPL_KERN);
	// 	break;
	// case 0x0b:
	// 	setTrap(idt + i, SEG_KCODE, (uint32_t)irqSegNotPresent, DPL_KERN);
	// 	break;
	// case 0x0c:
	// 	setTrap(idt + i, SEG_KCODE, (uint32_t)irqStackSegFault, DPL_KERN);
	// 	break;
	// case 0x0d:
	// 	setTrap(idt + i, SEG_KCODE, (uint32_t)irqGProtectFault, DPL_KERN);
	// 	break;
	// case 0x0e:
	// 	setTrap(idt + i, SEG_KCODE, (uint32_t)irqPageFault, DPL_KERN);
	// 	break;
	// case 0x11:
	// 	setTrap(idt + i, SEG_KCODE, (uint32_t)irqAlignCheck, DPL_KERN);
	// 	break;
	// case 0x1e:
	// 	setTrap(idt + i, SEG_KCODE, (uint32_t)irqSecException, DPL_KERN);
	// 	break;
	// case 0x20:
	// 	setIntr(idt + i, SEG_KCODE, (uint32_t)irqTimer, DPL_KERN);
	// 	break;
	// case 0x21:
	// 	setIntr(idt + i, SEG_KCODE, (uint32_t)irqKeyboard, DPL_KERN);
	// 	break;
	// case 0x80:
	// 	setIntr(idt + i, SEG_KCODE, (uint32_t)irqSyscall, DPL_USER);
	// 	break;
	// default:
	// 	setTrap(idt + i, SEG_KCODE, (uint32_t)irqErrorCode, DPL_KERN);
	// 	break;
